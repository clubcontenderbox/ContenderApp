// CONTENDER CLUB | SUPABASE VERSION 2026.08.12.2149 | SEGURIDAD ETAPA 5A-5B | RLS INICIAL SOCIOS + AUTH ADMIN/SOCIO
// ═══════════════════════════════════════════════════════════════
// VERSION DEL ARCHIVO: 2026.08.12.2149 | supabasedb_v2026.08.12.2149.js | Contender Club | SEGURIDAD ETAPA 5A-5B + 8D
//
// ETAPA 5A-5B REQUIERE ejecutar la migración SQL 2148 antes de probar.
// El bloque SQL histórico al final se conserva solo como referencia de migraciones anteriores.
// Cambia la extensión de este archivo a .js y conserva el nombre: supabasedb_v2026.08.12.2149.js.
// ═══════════════════════════════════════════════════════════════

var GymDB = (function () {
  'use strict';

  var CONTENDER_SUPABASE_VERSION = '2026.08.12.2149';
