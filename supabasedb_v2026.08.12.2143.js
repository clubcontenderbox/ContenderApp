// CONTENDER CLUB | SUPABASE VERSION 2026.08.12.2143 | SEGURIDAD ETAPA 8D | operador Auth automático
// ═══════════════════════════════════════════════════════════════
// VERSION DEL ARCHIVO: 2026.08.12.2143 | supabasedb_v2026.08.12.2143.js | Contender Club | SEGURIDAD ETAPA 8D
//
...
// Después cambia la extensión de este archivo a .js y conserva el nombre: supabasedb_v2026.08.12.2143.js.
// ═══════════════════════════════════════════════════════════════

var GymDB = (function () {
  'use strict';

  var CONTENDER_SUPABASE_VERSION = '2026.08.12.2143';
  ...
  function h(extra){
    var bearer=AUTH_SESSION&&AUTH_SESSION.access_token?AUTH_SESSION.access_token:KEY;
    ...
    return new Promise(function(resolve){
      ...
      fetch(url,opts).then(function(r){
        ...
        if(!r.ok){
          ...
          if(r.status===401&&AUTH_SESSION)mensajeUsuario='⚠ Sesión de administrador vencida. Vuelve a iniciar sesión.';
