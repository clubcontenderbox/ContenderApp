// ═══════════════════════════════════════════════════════════════
// VERSION DEL ARCHIVO: 2026.08.07.2200 | supabasedb_v2026.08.07.2200.js | Contender Club | actualización 2026-08-07
//
...
// Después cambia la extensión de este archivo a .js y conserva el nombre: supabasedb_v2026.08.07.2200.js.
// ═══════════════════════════════════════════════════════════════

var GymDB = (function () {
  'use strict';

  var CONTENDER_SUPABASE_VERSION = '2026.08.07.2200';
  ...
  return {
    ...
    addCheckin:function(sid){
      ...
      this.addSaldoMovimiento(sid,DB_CONFIG.PUNTOS_POR_CHECKIN,'checkin','Check-in');
      bump();return true;
    },
...
--    Cada check-in agrega +1 desde la aplicación.
