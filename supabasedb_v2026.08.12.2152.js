// CONTENDER CLUB | SUPABASE VERSION 2026.08.12.2152 | SEGURIDAD ETAPAS 7 + 9 | CIERRE ANON + LIMPIEZA LEGACY
// ═══════════════════════════════════════════════════════════════
// VERSION DEL ARCHIVO: 2026.08.12.2152 | supabasedb_v2026.08.12.2152.js | Contender Club | ETAPAS 7 + 9
//
...
// Cambia la extensión de este archivo a .js y conserva el nombre: supabasedb_v2026.08.12.2152.js.
// ═══════════════════════════════════════════════════════════════

var GymDB = (function () {
  'use strict';

  var CONTENDER_SUPABASE_VERSION = '2026.08.12.2152';
...
/*
ETAPAS 7 + 9 · VERSION 2026.08.12.2152
La seguridad SQL de esta versión se instala con el archivo separado:
seguridad_etapas_07_09_v2026.08.12.2152.txt

El SQL histórico fue retirado de este JavaScript para evitar que migraciones
antiguas vuelvan a abrir permisos anon o RPC legacy por accidente.
*/
