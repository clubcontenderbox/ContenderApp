// CONTENDER CLUB | SUPABASE VERSION 2026.08.12.2155 | TRAINER AUTH + ABONO POR VISITAS
// ═══════════════════════════════════════════════════════════════
// VERSION DEL ARCHIVO: 2026.08.12.2155 | supabasedb_v2026.08.12.2155.js | Contender Club | TRAINER AUTH + ABONO POR VISITAS
//
...
// Cambia la extensión de este archivo a .js y conserva el nombre: supabasedb_v2026.08.12.2155.js.
// ═══════════════════════════════════════════════════════════════

var GymDB = (function () {
  'use strict';

  var CONTENDER_SUPABASE_VERSION = '2026.08.12.2155';
  ...
  var C = {
    ...
    saldoMovimientos:[], abonosVisitas:[], anuncios:[], socioAppEstado:null
  };
  ...
  function loadSocioActual(){
    ...
    return Promise.all([
      ...
      C.socioAppEstado=res[11].length?res[11][0]:null;
  ...
  // ETAPA 12: carga operativa del entrenador. No descarga anuncios, trainers,
  // accesos de app, reportes ni otros catalogos administrativos.
  function loadTrainer(){
    ...
    return Promise.all([
      ...
      C.abonosVisitas=res[9].map(normalizarAbonoVisitas);
      C.trainers=[];C.anuncios=[];C.socioAppEstado=null;C.deudas={};C.cuentas=[];C.rutinas={};C.historico={ventas:[],checkins:[],socios:[]};
      return true;
    });
  }
  ...
  function loadAll(){
    ...
    return Promise.all([
      ...
      C.abonosVisitas=res[10].map(normalizarAbonoVisitas);C.anuncios=res[11].map(function(a){a.id=String(a.id);return a;});C.socioAppEstado=null;
...
ETAPA 12 TRAINER AUTH · VERSION 2026.08.12.2155
