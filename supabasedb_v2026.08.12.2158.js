// CONTENDER CLUB | SUPABASE VERSION 2026.08.12.2158 | TRAINER ANUNCIOS + TRAINER AUTH + ABONO POR VISITAS
// ═══════════════════════════════════════════════════════════════
// VERSION DEL ARCHIVO: 2026.08.12.2158 | supabasedb_v2026.08.12.2158.js | Contender Club | TRAINER AUTH + ABONO POR VISITAS
//
...
// Cambia la extensión de este archivo a .js y conserva el nombre: supabasedb_v2026.08.12.2158.js.
// ═══════════════════════════════════════════════════════════════

var GymDB = (function () {
  'use strict';

  var CONTENDER_SUPABASE_VERSION = '2026.08.12.2158';
  ...
  // ETAPA 12 / 2158: carga operativa del entrenador. Descarga anuncios vigentes;
  ...
  function loadTrainer(){
    ...
    return Promise.all([
      ...
      C.abonosVisitas=res[9].map(normalizarAbonoVisitas);
      C.anuncios=res[10].map(function(a){a.id=String(a.id);return a;});
      C.trainers=[];C.socioAppEstado=null;C.deudas={};C.cuentas=[];C.rutinas={};C.historico={ventas:[],checkins:[],socios:[]};
      return true;
    });
  }
...
ETAPA 12 TRAINER AUTH · VERSION 2026.08.12.2158
